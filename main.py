...
class SecureCreditCard(CreditCard):
    def __init__(self, number: str, expiry: str, holder: str, cvv: str, pin: str):
        super().__init__(number, expiry, holder, cvv)
        self.pin = pin
    def validate(self) -> bool:
        """
        Validates the credit card details.
...
try:
    ...
    if hotel.is_available():
        credit_card = CreditCard(number="1234567890123456", expiry="12/26", 
